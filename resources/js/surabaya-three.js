...
export default async function mountRight3D(containerId='3d-surabaya', modelUrl='/mnt/data/surabaya.glb') {
  ...
  catch(e){ console.error('load failed', e); try { const gltf = await loader.loadAsync('/models/surabaya.glb'); model = gltf.scene; } catch(err){ console.error('fallback failed', err); } }
